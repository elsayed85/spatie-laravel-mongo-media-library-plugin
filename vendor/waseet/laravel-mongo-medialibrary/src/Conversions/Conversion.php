...
class Conversion
{
    ...
    public function __construct(
        ...
        $this->manipulations = (new Manipulations())
            ->optimize(config('mongo-media-library.image_optimizers'))
            ->format(Manipulations::FORMAT_JPG);

        $this->fileNamer = app(config('mongo-media-library.file_namer'));

        $this->loadingAttributeValue = config('mongo-media-library.default_loading_attribute_value');

        $this->performOnQueue = config('mongo-media-library.queue_conversions_by_default', true);
    }
    ...
    public function getConversionFile(MongoMedia $media): string
    {
