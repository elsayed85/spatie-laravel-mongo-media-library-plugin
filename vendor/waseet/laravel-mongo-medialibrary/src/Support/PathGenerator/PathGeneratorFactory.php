...
use Waseet\MediaLibrary\MediaCollections\Exceptions\InvalidPathGenerator;
use Waseet\MediaLibrary\MediaCollections\Models\MongoMedia;

class PathGeneratorFactory
{
    public static function create(MongoMedia $media): PathGenerator
    {
    ...
    protected static function getPathGeneratorClass(MongoMedia $media)
    {
        $defaultPathGeneratorClass = config('mongo-media-library.path_generator');

        foreach (config('mongo-media-library.custom_path_generators', []) as $modelClass => $customPathGeneratorClass) {
    ...
    protected static function mediaBelongToModelClass(MongoMedia $media, string $modelClass): bool
    {
