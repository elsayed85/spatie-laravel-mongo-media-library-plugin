...
use Waseet\MediaLibrary\MediaCollections\Exceptions\InvalidConversion;
...
class ConversionCollection extends Collection
{
    ...
    public static function createForMedia(MongoMedia $media): self
    {
    ...
    protected function addConversionsFromRelatedModel(MongoMedia $media): void
    {
        ...
        /** @var \Waseet\MediaLibrary\HasMedia $model */
        $model = new $modelName();
    ...
    protected function addManipulationsFromDb(MongoMedia $media)
    {
