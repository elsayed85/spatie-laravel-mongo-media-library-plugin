...
class RegisteredResponsiveImages
{
    ...
    public function __construct(protected MongoMedia $media, string $conversionName = '')
    {
    ...
    public function getSrcset(): string
    {
        ...
        $shouldAddPlaceholderSvg = config('mongo-media-library.responsive_images.use_tiny_placeholders')
