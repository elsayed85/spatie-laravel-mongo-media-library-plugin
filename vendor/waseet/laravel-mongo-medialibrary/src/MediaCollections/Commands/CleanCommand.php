...
namespace Waseet\MediaLibrary\MediaCollections\Commands;
...
use Waseet\MediaLibrary\ResponsiveImages\RegisteredResponsiveImages;
...
class CleanCommand extends Command
{
    ...
    /** @return Collection<int, MongoMedia> */
    ...
    {
        $this->getOrphanedMediaItems()->each(function (MongoMedia $media): void {
            if ($this->isDryRun) {
    ...
    {
        $this->getMediaItems()->each(function (MongoMedia $media) {
    ...
    protected function deleteConversionFilesForDeprecatedConversions(MongoMedia $media): void
    {
    ...
    protected function deleteDeprecatedResponsiveImages(MongoMedia $media): void
    {
    ...
    {
        $diskName = $this->argument('disk') ?: config('mongo-media-library.disk_name');
    ...
    protected function markConversionAsRemoved(MongoMedia $media, string $conversionPath): void
    {
