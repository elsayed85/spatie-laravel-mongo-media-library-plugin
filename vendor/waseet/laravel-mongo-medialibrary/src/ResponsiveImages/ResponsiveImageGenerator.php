...
namespace Waseet\MediaLibrary\ResponsiveImages;
...
use Waseet\MediaLibrary\ResponsiveImages\Events\ResponsiveImagesGenerated;
use Waseet\MediaLibrary\ResponsiveImages\Exceptions\InvalidTinyJpg;
...
use Waseet\MediaLibrary\Support\FileNamer\FileNamer;
use Waseet\MediaLibrary\Support\ImageFactory;
...
class ResponsiveImageGenerator
{
    ...
    public function __construct(
        ...
        $this->fileNamer = app(config('mongo-media-library.file_namer'));
    }

    public function generateResponsiveImages(MongoMedia $media): void
    {
    ...
    public function generateResponsiveImagesForConversion(MongoMedia $media, Conversion $conversion, string $baseImage): void
    {
        $temporaryDirectory = TemporaryDirectory::create();
    ...
    protected function cleanResponsiveImages(MongoMedia $media, string $conversionName = 'media_library_original'): MongoMedia
    {
