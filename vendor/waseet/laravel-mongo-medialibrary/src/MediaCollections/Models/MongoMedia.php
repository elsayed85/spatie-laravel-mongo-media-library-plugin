...
namespace Waseet\MediaLibrary\MediaCollections\Models;
...
use Waseet\MediaLibrary\MediaCollections\HtmlableMedia;
use Waseet\MediaLibrary\Conversions\ConversionCollection;
use Waseet\MediaLibrary\Support\UrlGenerator\UrlGenerator;
use Waseet\MediaLibrary\MediaCollections\Models\Concerns\HasUuid;
use Waseet\MediaLibrary\Support\UrlGenerator\UrlGeneratorFactory;
use Waseet\MediaLibrary\MediaCollections\Models\Concerns\IsSorted;
...
use Waseet\MediaLibrary\MediaCollections\Models\Concerns\CustomMediaProperties;
 ...
 */
class MongoMedia extends Model implements Responsable, Htmlable, Attachable
{
    use IsSorted;
