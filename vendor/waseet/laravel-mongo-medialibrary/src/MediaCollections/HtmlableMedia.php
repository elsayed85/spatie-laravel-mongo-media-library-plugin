...
use Waseet\MediaLibrary\Conversions\ImageGenerators\Image;
...
class HtmlableMedia implements Htmlable, \Stringable
{
    ...
    public function toHtml()
    {
        ...
        $loadingAttributeValue = config('mongo-media-library.default_loading_attribute_value');
        ...
        if ($this->media->hasResponsiveImages($this->conversionName)) {
            $viewName = config('mongo-media-library.responsive_images.use_tiny_placeholders')
