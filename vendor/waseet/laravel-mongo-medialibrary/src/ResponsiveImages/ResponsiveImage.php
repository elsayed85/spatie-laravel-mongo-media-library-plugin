...
{
    public static function register(MongoMedia $media, $fileName, $conversionName)
    {
    ...
    public static function registerTinySvg(MongoMedia $media, string $base64Svg, string $conversionName)
    {
        $responsiveImages = $media->responsive_images;
    ...
    public function __construct(public string $fileName, public MongoMedia $media)
    {
    }
